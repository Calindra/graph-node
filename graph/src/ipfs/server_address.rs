...
mod tests {
    ...
    #[test]
    fn removes_the_path_from_an_address() {
        let addr = ServerAddress::new("https://example.com/api/v0/id").unwrap();
    ...
    fn removes_the_query_from_an_address() {
        let addr = ServerAddress::new("https://example.com/api/v0/id?format=json").unwrap();
